...
* `java Solution -i -a out.txt in.txt` (для целых чисел по возрастанию)
* `java Solution -s out.txt in1.txt in2.txt in3.txt` (для строк по возрастанию)
* `java Solution -d -s out.txt in1.txt in2.txt` (для строк по убыванию)
